...
national-holiday-api Japanse official site is here[http://dandydot.dyndns.org:8080/dokuwiki/doku.php?id=software:national-holiday-api].
...
* api/holidays/list/DATE1/DATE2 : Get holidays list between DATE1 and DATE2
...
* api/holidays/is_holiday/DATE1 : Check DATE1 is holiday?
...
* http://dandydot.dyndns.org:3001/api/holidays/list/2013-01-01/2013-12-31

* http://dandydot.dyndns.org:3001/api/holidays/is_holiday/2013-01-01
